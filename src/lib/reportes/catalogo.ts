...
async function alertas(): Promise<Documento> {
  ...
  return {
    ...
    columnas: [
      { titulo: "Alerta", ancho: 14 },
      { titulo: "Producto", ancho: 30, destacar: true },
      { titulo: "Dónde", ancho: 24 },
      { titulo: "Hay", ancho: 12, alinear: "derecha" },
      { titulo: "Debería / Vence", ancho: 14, alinear: "derecha" },
      { titulo: "Faltan", ancho: 12, alinear: "derecha" },
    ],
    filas,
